<template>
    <aside class="right-side">
        ...
        <section class="content-header">
            <h1> <span> {{ this.$route.meta.title }}   </span></h1>
                                        ...
                                        <ul class="list-unstyled margin-none">
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img :src='require("../../img/authors/avatar6.jpg")' class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-primary"></i> Annette
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img :src='require("../../img/authors/avatar.jpg")' class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-primary"></i> Jordan
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img :src='require("../../img/authors/avatar2.jpg")' class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-primary"></i> Stewart
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img :src='require("../../img/authors/avatar3.jpg")' class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-warning"></i> Alfred
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img :src='require("../../img/authors/avatar4.jpg")' class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-danger"></i> Eileen
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img :src='require("../../img/authors/avatar5.jpg")' class="img-circle float-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-muted"></i> Robert
                                                </a>
                                            </li>
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="javascript:void(0)">
                                                    <img :src='require("../../img/authors/avatar7.jpg")' class="img-circle float-right" alt="avatar-image">
                                        ...
                                        <ul class="list-unstyled m-t-15 notifications">
                                            <li>
                                                <a href="" class="message icon-not striped-col">
                                                    <img class="message-image img-circle" :src='require("../../img/authors/avatar3.jpg")' alt="avatar-image">
                                            ...
                                            <li>
                                                <a href="" class="message icon-not">
                                                    <img class="message-image img-circle" :src='require("../../img/authors/avatar.jpg")' alt="avatar-image">
                                                    <div class="message-body">
                                                        <strong>Tony</strong>
                                            ...
                                            <li>
                                                <a href="" class="message icon-not striped-col">
                                                    <img class="message-image img-circle" :src='require("../../img/authors/avatar6.jpg")' alt="avatar-image">
                                                    <div class="message-body">
                                                        <strong>John</strong>
                                            ...
                                            <li>
                                                <a href="" class="message icon-not">
                                                    <img class="message-image img-circle" :src='require("../../img/authors/avatar1.jpg")' alt="avatar-image">
                                                    <div class="message-body">
                                            ...
                                            <li>
                                                <a href="" class="message icon-not striped-col">
                                                    <img class="message-image img-circle" :src='require("../../img/authors/avatar7.jpg")' alt="avatar-image">
                                                    <div class="message-body">
