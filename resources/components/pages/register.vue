                ...
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        <validate tag="div">
                            ...
                            <input v-model="model.firstname" id="first" name="firstname" type="text" required autofocus
                ...
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        <validate tag="div">
                            ...
                            <input v-model="model.lastname" id="last" name="lastname" type="text" required autofocus
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group">
                        <validate tag="div">
                            ...
                            <input v-model="model.password" id="password" name="password" type="password" required
                                placeholder="Password" class="form-control" minlength="6" maxlength="10" />
                ...
                <div class="col-12">
                    <div class="form-group checkbox">
                        <label for="terms">
                            <input type="checkbox" name="terms" id="terms">&nbsp; I accept the <a
